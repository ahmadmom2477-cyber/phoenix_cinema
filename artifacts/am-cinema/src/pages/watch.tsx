...
export default function Watch() {
  ...
  }, [baseEmbedUrl, clickGuardActive, isTorrentMode]);
  ...
  return (
    <div className="flex-1 flex flex-col pt-20 md:pt-24 pb-8 md:pb-12 px-4 md:px-8 max-w-7xl mx-auto w-full">
      ...
      {/* Subtitle injected into player — show compact status for Source 4 / Torrent */}
      {autoSubStatus === "applied" && subtitleUrl && (providerId === "vidapiru" || isTorrentMode) && (
        <div className="mb-2">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
            ...
            {autoSubStatus === "applied" && subtitleUrl && (
              <div className="mb-3 space-y-2">
                ...
                {(providerId === "vidapiru" || isTorrentMode) ? (
