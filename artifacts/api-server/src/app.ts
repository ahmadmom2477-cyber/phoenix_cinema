...
if (process.env.NODE_ENV === "production") {
  const frontendPath = join(process.cwd(), "artifacts/am-cinema/dist/public");
  logger.info({ frontendPath, exists: existsSync(frontendPath) }, "Frontend static path");
  if (existsSync(frontendPath)) {
    ...
    logger.error({ frontendPath }, "Frontend build not found — static files will not be served");
  }
}
